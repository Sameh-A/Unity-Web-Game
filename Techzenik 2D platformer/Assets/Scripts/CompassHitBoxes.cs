...
public class CompassHitBoxes : MonoBehaviour
{
    public LayerMask whatIsPlayer;
    private SpriteRenderer theSR; 
    private CompassHitBoxes instance;
    ...
    void Update()
    {
        ...
        RaycastHit2D hitCentre  =  Physics2D.Raycast(new Vector3(transform.position.x,transform.position.y+(theSR.bounds.extents.y*.6f),transform.position.z),Vector2.up,.4f,whatIsPlayer);
        
        
        RaycastHit2D hitLeft =  Physics2D.Raycast(new Vector3(transform.position.x-(theSR.bounds.extents.x*.5f),transform.position.y+(theSR.bounds.extents.y*.6f),transform.position.z),Vector2.up,.4f,whatIsPlayer);


        RaycastHit2D hitRight =  Physics2D.Raycast(new Vector3(transform.position.x+(theSR.bounds.extents.x*.5f),transform.position.y+(theSR.bounds.extents.y*.6f),transform.position.z),Vector2.up,.4f,whatIsPlayer);
        ...
        Debug.DrawRay(new Vector3(transform.position.x,transform.position.y+(theSR.bounds.extents.y*.6f),transform.position.z), Vector2.up*.4f, Color.green);
        Debug.DrawRay(new Vector3(transform.position.x-(theSR.bounds.extents.x*.5f),transform.position.y+(theSR.bounds.extents.y*.6f),transform.position.z), Vector2.up*.4f, Color.green);
        Debug.DrawRay(new Vector3(transform.position.x+(theSR.bounds.extents.x*.5f),transform.position.y+(theSR.bounds.extents.y*.6f),transform.position.z), Vector2.up*.4f, Color.green);
