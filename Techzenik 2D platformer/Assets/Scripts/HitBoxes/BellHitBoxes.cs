...
public class BellHitBoxes : MonoBehaviour
{

    public LayerMask whatIsPlayer;
    private SpriteRenderer theSR; 
    public BellHitBoxes instance;
...
/*
     ...
     private void OnTriggerEnter2D(Collider2D other){
       ...
       disableHitCounter = .75f;
       PlayerController.instance.knockBackForce = PlayerController.instance.knockBackForce*2f;
       PlayerHealthController.instance.DealDamage(1);
       PlayerController.instance.knockBackForce = PlayerController.instance.knockBackForce/2f;
        }
