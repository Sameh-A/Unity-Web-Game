...
public class EagleHitBoxes : MonoBehaviour
{
    // Start is called before the first frame update
   public LayerMask whatIsPlayer;
    private SpriteRenderer theSR; 
    private EagleHitBoxes instance;
    ...
    void Update()
    {
           ...
           if ((hitLeft || hitCentre || hitRight))
        {
            ...
            EnemyEagleController enemy = this.transform.parent.gameObject.GetComponent<EnemyEagleController>();
