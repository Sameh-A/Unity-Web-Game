...
public class LaptopHitBoxes : MonoBehaviour
{
    public LayerMask whatIsPlayer;
    private SpriteRenderer theSR; 
    private LaptopHitBoxes instance;
    ...
    void Update()
    {
        ...
        RaycastHit2D hitLeft =  Physics2D.Raycast(new Vector3(transform.position.x-(theSR.bounds.extents.x*.1f),transform.position.y+(theSR.bounds.extents.y*.7f),transform.position.z),Vector2.up,.4f,whatIsPlayer);
        RaycastHit2D hitRight =  Physics2D.Raycast(new Vector3(transform.position.x+(theSR.bounds.extents.x*.1f),transform.position.y+(theSR.bounds.extents.y*.7f),transform.position.z),Vector2.up,.4f,whatIsPlayer);

        RaycastHit2D hitLeft2 =  Physics2D.Raycast(new Vector3(transform.position.x-(theSR.bounds.extents.x*.2f),transform.position.y+(theSR.bounds.extents.y*.7f),transform.position.z),Vector2.up,.4f,whatIsPlayer);
        RaycastHit2D hitRight2 =  Physics2D.Raycast(new Vector3(transform.position.x+(theSR.bounds.extents.x*.2f),transform.position.y+(theSR.bounds.extents.y*.7f),transform.position.z),Vector2.up,.4f,whatIsPlayer);
        ...
        RaycastHit2D hitLeft4 =  Physics2D.Raycast(new Vector3(transform.position.x-(theSR.bounds.extents.x*.4f),transform.position.y+(theSR.bounds.extents.y*.7f),transform.position.z),Vector2.up,.4f,whatIsPlayer);
        RaycastHit2D hitRight4 =  Physics2D.Raycast(new Vector3(transform.position.x+(theSR.bounds.extents.x*.4f),transform.position.y+(theSR.bounds.extents.y*.7f),transform.position.z),Vector2.up,.4f,whatIsPlayer);

        RaycastHit2D hitLeft5 =  Physics2D.Raycast(new Vector3(transform.position.x-(theSR.bounds.extents.x*.5f),transform.position.y+(theSR.bounds.extents.y*.7f),transform.position.z),Vector2.up,.4f,whatIsPlayer);
        RaycastHit2D hitRight5 =  Physics2D.Raycast(new Vector3(transform.position.x+(theSR.bounds.extents.x*.5f),transform.position.y+(theSR.bounds.extents.y*.7f),transform.position.z),Vector2.up,.4f,whatIsPlayer);
        ...
        RaycastHit2D hitLeft7 =  Physics2D.Raycast(new Vector3(transform.position.x-(theSR.bounds.extents.x*.7f),transform.position.y+(theSR.bounds.extents.y*.7f),transform.position.z),Vector2.up,.4f,whatIsPlayer);
        RaycastHit2D hitRight7 =  Physics2D.Raycast(new Vector3(transform.position.x+(theSR.bounds.extents.x*.7f),transform.position.y+(theSR.bounds.extents.y*.7f),transform.position.z),Vector2.up,.4f,whatIsPlayer);

        RaycastHit2D hitLeft8 =  Physics2D.Raycast(new Vector3(transform.position.x-(theSR.bounds.extents.x*.6f),transform.position.y+(theSR.bounds.extents.y*.7f),transform.position.z),Vector2.up,.4f,whatIsPlayer);
        RaycastHit2D hitRight8 =  Physics2D.Raycast(new Vector3(transform.position.x+(theSR.bounds.extents.x*.6f),transform.position.y+(theSR.bounds.extents.y*.7f),transform.position.z),Vector2.up,.4f,whatIsPlayer);


         RaycastHit2D hitRightAngle =  Physics2D.Raycast(new Vector3(transform.position.x+(theSR.bounds.extents.x*.6f),transform.position.y+(theSR.bounds.extents.y*.3f),transform.position.z),new Vector2(1,1.75f),.3f,whatIsPlayer);

        RaycastHit2D hitLeftAngle =  Physics2D.Raycast(new Vector3(transform.position.x-(theSR.bounds.extents.x*.6f),transform.position.y+(theSR.bounds.extents.y*.3f),transform.position.z),new Vector2(-1,1.75f),.3f,whatIsPlayer);
    ...
    /*
        ...
        Debug.DrawRay(new Vector3(transform.position.x-(theSR.bounds.extents.x*.7f),transform.position.y+(theSR.bounds.extents.y*.7f),transform.position.z), Vector2.up*.4f, Color.green);
        Debug.DrawRay(new Vector3(transform.position.x+(theSR.bounds.extents.x*.7f),transform.position.y+(theSR.bounds.extents.y*.7f),transform.position.z), Vector2.up*.4f, Color.green);
       
        Debug.DrawRay(new Vector3(transform.position.x-(theSR.bounds.extents.x*.8f),transform.position.y+(theSR.bounds.extents.y*.7f),transform.position.z), Vector2.up*.4f, Color.green);
        Debug.DrawRay(new Vector3(transform.position.x+(theSR.bounds.extents.x*.8f),transform.position.y+(theSR.bounds.extents.y*.7f),transform.position.z), Vector2.up*.4f, Color.green);

        Debug.DrawRay(new Vector3(transform.position.x+(theSR.bounds.extents.x*.6f),transform.position.y+(theSR.bounds.extents.y*.3f),transform.position.z), new Vector2(1,1.75f)*.3f, Color.green);
        Debug.DrawRay(new Vector3(transform.position.x-(theSR.bounds.extents.x*.6f),transform.position.y+(theSR.bounds.extents.y*.3f),transform.position.z), new Vector2(-1,1.75f)*.3f, Color.green);
*/



           if ((hitLeft || hitCentre || hitRight ||hitRight2 ||hitLeft2 || hitRight3 || hitLeft3|| hitRight4|| hitLeft4 || hitRight5 || hitLeft5 || hitRight6|| hitLeft6|| hitRight7|| hitLeft7|| hitRight8|| hitLeft8|| hitRightAngle || hitLeftAngle))
        {
            ...
            LaptopController enemy = this.transform.parent.gameObject.GetComponent<LaptopController>();
