...
public class LevelManager : MonoBehaviour
{
  ...
  private static extern string getUserName();
    ...
    private IEnumerator RespawnCo()
    {
        ...
        EnemyManagerLight.instance.RespawnEnemies();
        }
        else if (theme == "sound"){
            EnemyManagerSound.instance.RespawnEnemies();
        }
        if(hasSpikeManager){
            resetSpikesRetract.instance.resetAllSpikes();
        }
