...
public class PlugHitBoxes : MonoBehaviour
{
    public LayerMask whatIsPlayer;
    private SpriteRenderer theSR; 
    private PlugHitBoxes instance;
    ...
    void Update()
    {
        ...
        RaycastHit2D hitCentre  =  Physics2D.Raycast(new Vector3(transform.position.x,transform.position.y+(theSR.bounds.extents.y*.3f),transform.position.z),Vector2.up,.6f,whatIsPlayer);
        
        
        RaycastHit2D hitLeft =  Physics2D.Raycast(new Vector3(transform.position.x-(theSR.bounds.extents.x*.5f),transform.position.y+(theSR.bounds.extents.y*.3f),transform.position.z),Vector2.up,.65f,whatIsPlayer);


        RaycastHit2D hitRight =  Physics2D.Raycast(new Vector3(transform.position.x+(theSR.bounds.extents.x*.5f),transform.position.y+(theSR.bounds.extents.y*.3f),transform.position.z),Vector2.up,.65f,whatIsPlayer);


        RaycastHit2D hitRightAngle =  Physics2D.Raycast(new Vector3(transform.position.x+(theSR.bounds.extents.x*.5f),transform.position.y+(theSR.bounds.extents.y*.3f),transform.position.z),new Vector2(1,1),.3f,whatIsPlayer);

        RaycastHit2D hitLeftAngle =  Physics2D.Raycast(new Vector3(transform.position.x-(theSR.bounds.extents.x*.5f),transform.position.y+(theSR.bounds.extents.y*.3f),transform.position.z),new Vector2(-1,1),.3f,whatIsPlayer);

    
        Debug.DrawRay(new Vector3(transform.position.x,transform.position.y+(theSR.bounds.extents.y*.3f),transform.position.z), Vector2.up*.6f, Color.green);
        Debug.DrawRay(new Vector3(transform.position.x-(theSR.bounds.extents.x*.5f),transform.position.y+(theSR.bounds.extents.y*.3f),transform.position.z), Vector2.up*.6f, Color.green);
        Debug.DrawRay(new Vector3(transform.position.x+(theSR.bounds.extents.x*.5f),transform.position.y+(theSR.bounds.extents.y*.3f),transform.position.z), Vector2.up*.6f, Color.green);

        Debug.DrawRay(new Vector3(transform.position.x+(theSR.bounds.extents.x*.5f),transform.position.y+(theSR.bounds.extents.y*.3f),transform.position.z), new Vector2(1,1)*.3f, Color.green);
      
       Debug.DrawRay(new Vector3(transform.position.x-(theSR.bounds.extents.x*.5f),transform.position.y+(theSR.bounds.extents.y*.3f),transform.position.z), new Vector2(-1,1)*.3f, Color.green);



           if ((hitLeft || hitCentre || hitRight || hitRightAngle ||  hitLeftAngle ))
        {
