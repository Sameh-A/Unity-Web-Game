...
public class SocketHitBoxes : MonoBehaviour
{
    public LayerMask whatIsPlayer;
    private SpriteRenderer theSR; 
    private SocketHitBoxes instance;
    ...
    void Update()
    {
        ...
        RaycastHit2D hitCentre  =  Physics2D.Raycast(new Vector3(transform.position.x,transform.position.y+(theSR.bounds.extents.y*.3f),transform.position.z),Vector2.up,.65f,whatIsPlayer);
        ...
        Debug.DrawRay(new Vector3(transform.position.x,transform.position.y+(theSR.bounds.extents.y*.3f),transform.position.z), Vector2.up*.4f, Color.green);
        Debug.DrawRay(new Vector3(transform.position.x-(theSR.bounds.extents.x*.5f),transform.position.y+(theSR.bounds.extents.y*.3f),transform.position.z), Vector2.up*.4f, Color.green);
        Debug.DrawRay(new Vector3(transform.position.x+(theSR.bounds.extents.x*.5f),transform.position.y+(theSR.bounds.extents.y*.3f),transform.position.z), Vector2.up*.4f, Color.green);
