...
public class TambourineHitBoxes : MonoBehaviour
{
      public LayerMask whatIsPlayer;
    private SpriteRenderer theSR; 
    public TambourineHitBoxes instance;
    ...
    /*
        ...
        Debug.DrawRay(new Vector3(transform.position.x-(theSR.bounds.extents.x*.5f),transform.position.y+(theSR.bounds.extents.y*.8f),transform.position.z), Vector2.up*.4f, Color.green);
        Debug.DrawRay(new Vector3(transform.position.x+(theSR.bounds.extents.x*.5f),transform.position.y+(theSR.bounds.extents.y*.8f),transform.position.z), Vector2.up*.4f, Color.green);
        
        Debug.DrawRay(new Vector3(transform.position.x-(theSR.bounds.extents.x*.4f),transform.position.y+(theSR.bounds.extents.y*.8f),transform.position.z), Vector2.up*.4f, Color.green);
        Debug.DrawRay(new Vector3(transform.position.x+(theSR.bounds.extents.x*.4f),transform.position.y+(theSR.bounds.extents.y*.8f),transform.position.z), Vector2.up*.4f, Color.green);
        
        Debug.DrawRay(new Vector3(transform.position.x-(theSR.bounds.extents.x*.6f),transform.position.y+(theSR.bounds.extents.y*.8f),transform.position.z), Vector2.up*.4f, Color.green);
        Debug.DrawRay(new Vector3(transform.position.x+(theSR.bounds.extents.x*.6f),transform.position.y+(theSR.bounds.extents.y*.8f),transform.position.z), Vector2.up*.4f, Color.green);
        
        Debug.DrawRay(new Vector3(transform.position.x-(theSR.bounds.extents.x*.67f),transform.position.y+(theSR.bounds.extents.y*.8f),transform.position.z), Vector2.up*.4f, Color.green);
        Debug.DrawRay(new Vector3(transform.position.x+(theSR.bounds.extents.x*.67f),transform.position.y+(theSR.bounds.extents.y*.8f),transform.position.z), Vector2.up*.4f, Color.green);

         Debug.DrawRay(new Vector3(transform.position.x-(theSR.bounds.extents.x*.3f),transform.position.y+(theSR.bounds.extents.y*.8f),transform.position.z), Vector2.up*.4f, Color.green);
        Debug.DrawRay(new Vector3(transform.position.x+(theSR.bounds.extents.x*.3f),transform.position.y+(theSR.bounds.extents.y*.8f),transform.position.z), Vector2.up*.4f, Color.green);

         Debug.DrawRay(new Vector3(transform.position.x-(theSR.bounds.extents.x*.2f),transform.position.y+(theSR.bounds.extents.y*.8f),transform.position.z), Vector2.up*.4f, Color.green);
        Debug.DrawRay(new Vector3(transform.position.x+(theSR.bounds.extents.x*.2f),transform.position.y+(theSR.bounds.extents.y*.8f),transform.position.z), Vector2.up*.4f, Color.green);


        Debug.DrawRay(new Vector3(transform.position.x-(theSR.bounds.extents.x*.1f),transform.position.y+(theSR.bounds.extents.y*.8f),transform.position.z), Vector2.up*.4f, Color.green);
        Debug.DrawRay(new Vector3(transform.position.x+(theSR.bounds.extents.x*.1f),transform.position.y+(theSR.bounds.extents.y*.8f),transform.position.z), Vector2.up*.4f, Color.green);
 ...
 */
           ...
           if ((hitLeft ||hitLeft2 ||hitLeft3 ||hitLeft4 ||hitLeft5 || hitCentre || hitRight || hitRight2 || hitRight3|| hitRight4 || hitRight5 ||hitRightAngle || hitLeftAngle ||hitLeft6 || hitRight6 || hitRight6dot7||hitLeft6dot7))
        {
            ...
            TambourineController tambourine = this.transform.parent.gameObject.GetComponent<TambourineController>();
            Instantiate(deathEffect,transform.position,transform.rotation);
            tambourine.instance.SelfDestroy();
